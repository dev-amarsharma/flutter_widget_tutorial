...
## Overview
Side Effects in Compose is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Side Effects in Compose solves.
...
@Composable
fun SampleScreen() {
    // Apply Side Effects in Compose here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/side-effects
