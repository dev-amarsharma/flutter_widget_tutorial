...
## Overview
Project Notes App focuses on CRUD note management in the Real Projects path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
