...
## Overview
remember Optimization is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what remember Optimization solves.
...
@Composable
fun SampleScreen() {
    // Apply remember Optimization here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/performance
