...
## Overview
Repository Pattern focuses on data access abstraction in the Architecture path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
...
## Next step
Review `hilt_setup` next, then try the concept in a small sample.
