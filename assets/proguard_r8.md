...
## Overview
ProGuard and R8 focuses on code shrinking and obfuscation in the Android Core path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.

## When to use
- When you are learning or applying android concepts in this curriculum.
