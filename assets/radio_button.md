# RadioButton in Compose

## Overview
RadioButton in Compose is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what RadioButton in Compose solves.
...
@Composable
fun SampleScreen() {
    // Apply RadioButton in Compose here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/components/radio-button
