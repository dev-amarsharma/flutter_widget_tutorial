...
## Overview
rememberCoroutineScope is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what rememberCoroutineScope solves.
...
@Composable
fun SampleScreen() {
    // Apply rememberCoroutineScope here.
}
```
...
## Official references
- Primary: https://developer.android.com/reference/kotlin/androidx/compose/runtime/package-summary#rememberCoroutineScope()
