...
## Overview
Project Chat App focuses on real-time messaging flows in the Real Projects path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
