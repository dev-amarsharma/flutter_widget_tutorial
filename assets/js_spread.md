...
## Overview
Spread/rest syntax makes copying, merging, and collecting values concise.

## Why this topic matters
Learning Spread & Rest helps you write cleaner, more maintainable code and improves real-world development confidence.
...
console.log(explainTopic("Spread & Rest"));
```
...
- Topic-specific reference: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Spread_syntax
