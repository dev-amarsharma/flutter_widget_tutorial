...
## Overview
Suspend Functions is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Suspend Functions solves.
...
## Official references
- Primary: https://kotlinlang.org/docs/coroutines-basics.html#extract-function-refactoring
