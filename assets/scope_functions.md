...
## Overview
Scope Functions focuses on let, run, apply, also, with in the Kotlin Foundations path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
