...
## Overview
Kotlin Scope Functions is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Kotlin Scope Functions solves.
...
## Official references
- Primary: https://kotlinlang.org/docs/scope-functions.html
