...
## Overview
TextField in Compose is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what TextField in Compose solves.
...
@Composable
fun SampleScreen() {
    // Apply TextField in Compose here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/text/user-input
