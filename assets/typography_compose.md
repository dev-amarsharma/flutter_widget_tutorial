...
## Overview
Typography in Compose is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Typography in Compose solves.
...
@Composable
fun SampleScreen() {
    // Apply Typography in Compose here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/designsystems/material3#typography
