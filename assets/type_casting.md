...
## Overview
Type Casting focuses on safe and unsafe casts in the Kotlin Foundations path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
