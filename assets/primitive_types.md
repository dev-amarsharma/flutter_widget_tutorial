...
## Overview
Primitive Types focuses on numeric and boolean types in the Kotlin Foundations path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.

## When to use
- When you are learning or applying kotlin concepts in this curriculum.
- When the topics listed before this one in the track already make sense.

## Example
```kotlin
fun greet(name: String = "Android") = "Hello, $name"
```
