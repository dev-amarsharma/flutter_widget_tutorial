...
## Overview
Pointer Input in Compose is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Pointer Input in Compose solves.
...
@Composable
fun SampleScreen() {
    // Apply Pointer Input in Compose here.
}
```
...
## Official references
- Primary: https://developer.android.com/develop/ui/compose/touch-input/pointer-input
