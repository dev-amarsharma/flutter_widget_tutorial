...
## Overview
UI Testing on Android is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what UI Testing on Android solves.
...
@Composable
fun SampleScreen() {
    // Apply UI Testing on Android here.
}
```
...
## Official references
- Primary: https://developer.android.com/training/testing/ui-tests
