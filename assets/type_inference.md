...
## Overview
Kotlin Type Inference is a key topic for building reliable Android apps with Kotlin and Jetpack Compose.

## Learning goals
- Understand what Kotlin Type Inference solves.
...
## Official references
- Primary: https://kotlinlang.org/docs/basic-types.html#type-inference
