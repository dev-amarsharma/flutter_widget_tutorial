...
## Overview
Type Inference focuses on compiler type inference in the Kotlin Foundations path. It helps you build production-ready Android and Kotlin skills with smaller, testable steps.
